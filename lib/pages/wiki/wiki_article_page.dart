...
class WikiArticlePage extends ConsumerWidget {
  ...
  Widget _buildContent(BuildContext context, String id) {
    ...
    final content = _contentFor(context, id, normalizedId);
    if (!_kBookableFacilityArticleIds.contains(normalizedId)) return content;
  ...
  Widget _contentFor(BuildContext context, String id, String normalizedId) {
    switch (normalizedId) {
      ...
      case 'subcategory-finance':
        return _SubcategoryPage(
          description:
              'The Finance specialization equips students with analytical tools to navigate global markets, sustainable investing, and emerging fintech applications.',
          courses: [
      ...
      case 'subcategory-it-operations':
        return _SubcategoryPage(
          description:
              'Explore syllabi covering data science, digital transformation (DX), and the management of organizational processes.',
          courses: [
            ('course-itc1080', 'ITC1080: Data-Driven Organization'),
            (
              'course-itc2080',
              'ITC2080: Management for Digital Transformation',
            ),
      ...
      case 'subcategory-general-management':
        return _SubcategoryPage(
          description:
              'Core management topics covering international strategy, entrepreneurship, and organizational control.',
          courses: [
            ('course-mgt1130', 'MGT1130: International Management'),
            ('course-mgt1140', 'MGT1140: Business Decision-Making and Control'),
            (
              'course-mgt2120',
              'MGT2120: Entrepreneurship & Small Business Dev.',
            ),
          ],
          context: context,
        );
      ...
      case 'category-gso':
        return _PlaceholderCategory(
          ...
          message:
              'GSO Guidelines, Event Planning, and Budget Processes will be published here.',
        );
      ...
      case 'course-fin2090':
        return _CourseArticle(
          ...
          credits: '2 Credits',
          description:
              'This course will give you an overview of how psychological biases and cognitive limitations shape financial decisions, market behavior, and investment outcomes, with a focus on real-world applications in business and finance.',
          objective:
              'In today\'s complex financial landscape, understanding how people actually make decisions is critical for designing effective business strategies and financial products. The objective is to provide an overview of key concepts in behavioral finance, including how cognitive biases, emotions, and social influences affect financial decision-making.',
      ...
      case 'course-fin2080':
        return _CourseArticle(
          ...
          credits: '2 Credits',
          description:
              'Students will be given an overview of the financial markets and the new investment trends of sustainable finance. This course focuses on three core components: environment, social, and governance (ESG).',
          objective:
              'This course aims to provide students with an understanding of the linkages between global capital markets and funding environment, social and governance (ESG) related projects.',
          objectiveLabel: 'Learning Objectives',
        );
      case 'course-fin3020':
        return _CourseArticle(
          ...
          credits: '2 Credits',
          description:
              'In this course, you will be given an overview of finance and technology (fintech). What is fintech, when did it originate, what are the major trends going forward. The course will also provide an introduction to digital currencies and blockchain.',
          objective:
              'Fintech is increasingly changing the way for payments and investing. You will gain an understanding of the complex structure of payment methods and financial regulations, and employ strategies in developing a fintech strategy for your business.',
      ...
      case 'course-itc1080':
        return _CourseArticleWithList(
          ...
          credits: '2 Credits',
          description:
              'Companies are embracing Digital Transformation (DX) as their main agenda. Yet being more "digital" or collecting more data won\'t get the companies very far if there aren\'t methods and tools to better the management process.',
      ...
      case 'course-itc2080':
        return _CourseArticle(
          ...
          credits: '2 Credits',
          description:
              'This course provides essential frameworks and associated keywords that help to understand digital transformation (DX). The course aims to investigate three core topics: DX process, DX structure, and DX culture within an organization.',
          objective:
              'Discussions around these themes are based on the notion of "sociotechnical system" which regards a work system as correlative interacting systems of the social system and the technical system.',
      ...
      case 'course-itc2020':
        return _CourseArticle(
          ...
          credits: '2 Credits',
          description:
              'This course is for those new to data science and interested in understanding why the Big Data Era has come to be. This course introduces you data-analytic thinking.',
          objective:
              'Recognize different data elements in your own work, explain why your team needs to design a Big Data Infrastructure Plan, select a data model, retrieve data, process patterns, and design an approach leveraging machine learning processes.',
          objectiveLabel: 'Learning Objectives',
        );
      case 'course-opr1010':
        return _CourseArticle(
          ...
          credits: '2 Credits',
          description:
              'Operations is one of three basic functions/pillars in any business organization. Operations Management (OM) is the management of systems or processes that create goods and/or provide services, within an organization.',
          objective:
              'Students will familiarize with basic knowledge of production and processes, including a strategic view of operations management, process thinking, lean thinking, quality management, and inventory management. Japanese way of operations will also be introduced.',
          objectiveLabel: 'Learning Objectives',
        );
      case 'course-mgt1130':
        return _CourseArticleWithList(
          ...
          credits: '2 Credits',
          description:
              'This course of international management is designed to equip students with essential knowledge and skills for effective management within the global business landscape.',
      ...
      case 'course-mgt1140':
        return _CourseArticle(
          ...
          credits: '2 Credits',
          description:
              'This course introduces students to the evolving role of managerial accounting in modern business environments. Topics include cost estimation, cost analysis, activity-based costing, cost-volume-profits analysis, budgets and standards.',
          objective:
              'The course highlights the informational needs of managers in planning, controlling, and decision making, and shows how to take advantage of accounting data in various situations.',
          objectiveLabel: 'Learning Objectives',
        );
      case 'course-mgt2120':
        return _CourseArticle(
          ...
          credits: '2 Credits',
          description:
              'This course is particularly useful for students who are interested in starting their own business and want to learn different aspects of business management.',
          objective:
              'Evaluate qualities of the successful entrepreneurial profile; determine the steps necessary to open and operate a small business enterprise; identify marketing and financial competencies; and ultimately develop and present a Business Plan.',
          objectiveLabel: 'Learning Objectives',
        );
      ...
      case 'subcategory-intl-relations':
        return _SubcategoryPage(
          description:
              'The International Relations Program (IRP) prepares graduates to analyze global political dynamics, security studies, and diplomacy. Students earn an MA in International Relations or MA in Political Science.',
          courses: const [],
          context: context,
          emptyMessage:
              'IRP course syllabi will be published here by the GSIR faculty.',
        );
      case 'subcategory-intl-development':
        return _SubcategoryPage(
          description:
              'The International Development Program (IDP) focuses on economic development, poverty reduction, and policy analysis in developing contexts. Graduates earn an MA in International Development or MA in Economics.',
          courses: const [],
          context: context,
          emptyMessage:
              'IDP course syllabi will be published here by the GSIR faculty.',
        );
      case 'subcategory-public-management':
        return _SubcategoryPage(
          description:
              'The Public Management and Policy Analysis Program (PMPP) trains future public servants and policy analysts. Graduates earn an MA in Public Management or MA in Public Policy.',
          courses: const [],
          context: context,
          emptyMessage:
              'PMPP course syllabi will be published here by the GSIR faculty.',
        );
      ...
      default:
        return Text(
          'Content for "$id" is not yet available.',
        ...
        builder: (ctx, setState) => submitted
            ? const Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    'Your suggestion is pending review.',
    ...
    return Column(
      ...
      children: [
        ...
        ...[
          ...
          (item) => _subcategoryTile(ctx, item.$1, item.$2, item.$3, item.$4),
        ),
        const SizedBox(height: 16),
        const Text(
        ...
        ...[
          (
            'subcategory-intl-relations',
            'International Relations',
            const Color(0xFFFDF2F8),
            const Color(0xFF9333EA),
          ),
          (
            'subcategory-intl-development',
            'International Development',
            const Color(0xFFFFF7ED),
            const Color(0xFFEA580C),
          ),
          (
            'subcategory-public-management',
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(p.$1, color: p.$3, size: 18),
                  ),
                  const SizedBox(width: 12),
                  Text(
                    p.$4,
...
class _AcademicsCategory extends StatelessWidget {
  ...
  Widget build(BuildContext ctx) {
    return Column(
      ...
      children: [
        const Text(
          'Guides on academic procedures, calendar synchronization, and cross-registration.',
          style: TextStyle(fontSize: 14, color: AppColors.textPrimary),
        ),
        const SizedBox(height: 16),
        HoverCard(
    ...
    return Column(
      ...
      children: [
        ...
        ...[
          (
            'Snow Boots',
            'Do not rely on regular sneakers. Buy tall, waterproof snow boots with deep treads.',
          ),
          (
            'Layering',
            'Heattech (from Uniqlo) is highly recommended. Always wear a thermal base layer.',
          ),
              ...
              child: Container(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4),
                    Text(
                      'Use the designated RED local bags. Includes food waste, paper that can\'t be recycled, and small plastics.',
              ...
              child: Container(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4),
                    Text(
                      'Use the designated BLUE local bags. Includes ceramics, glass, metals, and hard plastics.',
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        const Text(
          'The IUJ shuttle runs daily between campus and Urasa Station. The ride takes approximately 10-15 minutes.',
          style: TextStyle(fontSize: 14, color: AppColors.textPrimary),
        ),
        const SizedBox(height: 12),
        ...[
        ...
        const SizedBox(height: 8),
        const Text(
          '* Schedules are subject to change during holidays and heavy snow days.',
          style: TextStyle(
            fontSize: 12,
            color: AppColors.textMuted,
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              ...[
                '1 Hour before (Get ready / Review notes)',
                '30 Minutes before (Leave dorm / Walk to main building)',
                '10 Minutes before (Find your seat)',
              ].map(
                (item) => Padding(
                  padding: const EdgeInsets.only(bottom: 4, left: 8),
                  child: Row(
  ...
  Widget build(BuildContext ctx) {
    final pages = [
      (
        ...
        Icons.info_outline,
        'About IUJ',
        'History, mission, and key facts about IUJ.',
      ),
      (
        'access-transport',
        Icons.train_outlined,
        'Getting to Campus',
        'Urasa Station, Shinkansen, shuttle schedule.',
      ),
      (
        'admissions-overview',
        Icons.school_outlined,
        'Admissions Overview',
        'Deadlines, requirements, and application steps.',
      ),
      (
        'research-centers',
        Icons.science_outlined,
        'Research Centers',
        'GLOCOM, Case Center, Research Institute.',
      ),
    ];
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ...[
          (
            'Japan\'s first all-English graduate university',
            'IUJ was the first graduate-level university in Japan to offer all programs entirely in English.',
          ),
          (
            '60+ nationalities',
            'Students from over 60 countries study together on a fully residential campus, creating one of Japan\'s most internationally diverse graduate communities.',
          ),
          (
            'Small class sizes',
            'Low faculty-to-student ratios enable close mentorship and direct engagement with professors.',
          ),
          (
            'Fully residential',
            'All students live on campus in Minami-Uonuma — a model that fosters deep intercultural exchange outside the classroom.',
          ),
          (
            '~50% international faculty',
            'Approximately half the faculty are from overseas, bringing a genuinely global perspective to teaching and research.',
          ),
        ].map(
          (f) => Padding(
        ...
        ...[
          (
            'GSIR',
            'Graduate School of International Relations — MA and PhD programs in International Relations, International Development, and Public Management & Policy.',
          ),
          (
            'GSIM',
            'Graduate School of International Management — MBA, Intensive MBA, Digital Transformation Program (DXP), and International Social Entrepreneurship Program (ISEP).',
          ),
          (
            'CLEAR',
            'Center for Language Education and Research — English and Japanese language programs supporting all students.',
          ),
        ].map(
          (s) => Padding(
            padding: const EdgeInsets.only(bottom: 10),
      ...
      children: [
        ...
        ...[
          (
            'Research Institute',
            Icons.hub_outlined,
            'Manages grants, publications, and institutional research support. Maintains an archive of research initiatives and oversees research compliance and ethics guidelines.',
          ),
          (
            'GLOCOM',
            Icons.public_outlined,
            'A separate research center focused on globalization and communications research. Accessible via glocom.org.',
          ),
          (
            'Case Center',
            Icons.cases_outlined,
            'Dedicated facility for developing and analyzing real-world business case studies. Used extensively in GSIM teaching.',
          ),
          (
            'Researchers Information Database',
            Icons.manage_search_outlined,
            'Searchable portal mapping faculty and researcher expertise across IUJ. Available at rmap.iuj.ac.jp.',
          ),
          (
            'Matsushita Library (MLIC)',
            Icons.local_library_outlined,
            'The main campus library providing comprehensive academic resources, journal databases, and study spaces. Contact: library@iuj.ac.jp  |  Ext. 4333.',
          ),
        ].map(
          (r) => Container(
